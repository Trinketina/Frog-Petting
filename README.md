...
Simply right click (or use the keybind! on) any animal and watch them send little hearts of affection with a little animation~
...
<details>
<summary>Note: Some interactions work slightly differently with right click:</summary>
...
***Required serverside for this functionality prior to 5.0**. if not present, the animals will toggle sitting/standing regardless of being pet
</details>
