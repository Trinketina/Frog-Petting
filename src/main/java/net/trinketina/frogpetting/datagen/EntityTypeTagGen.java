...
public class EntityTypeTagGen extends FabricTagProvider.EntityTypeTagProvider {
    ...
    public static final TagKey<EntityType<?>> ALLOW_PETTING = TagKey.of(RegistryKeys.ENTITY_TYPE, Identifier.of(PettingClient.MOD_ID, "allow_petting"));
    public static final TagKey<EntityType<?>> BLOCK_PETTING = TagKey.of(RegistryKeys.ENTITY_TYPE, Identifier.of(PettingClient.MOD_ID, "block_petting"));
