...
public abstract class PettableCat
    ...
    @Override public void uniqueInteraction(PlayerEntity player, Hand hand) {
        ...
        if (Math.random() > .2f)
            this.getWorld().playSoundFromEntity(player, this, SoundEvents.ENTITY_CAT_PURR, SoundCategory.AMBIENT, this.getSoundVolume(), this.getSoundPitch());
        else
            this.getWorld().playSoundFromEntity(player, this, SoundEvents.ENTITY_CAT_PURREOW, SoundCategory.AMBIENT, this.getSoundVolume(), this.getSoundPitch());
    }
